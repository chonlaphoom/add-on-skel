        ...
        case "btnApiEvent":
            {
                ...
                if (bRegister){
                    window.Application.ApiEvent.AddApiEventListener('NewPresentation', OnNewDocumentApiEvent)
                }
                else{
                    window.Application.ApiEvent.RemoveApiEventListener('NewPresentation', OnNewDocumentApiEvent)
                }
