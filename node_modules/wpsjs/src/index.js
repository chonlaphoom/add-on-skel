...
program
	.version(`${require('../package').name} ${require('../package').version}`)
...
program
	...
	.option('--exe', '打包成exe(仅win平台)')
	.allowUnknownOption()
	.action((cmd) => {
		require('./lib/build.js').build(cmd)
	})
...
program.on('--help', () => {
	console.log(`\n  ` + chalk.green('在QQ群中交流wpsjs工具包的问题和建议, QQ群:185170323'))
})
